...
export function ReportModal({ isOpen, onClose }: ReportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-white max-w-md w-full p-8 border-2 border-gray-900">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        {/* Header */}
        <h3 className="text-2xl text-gray-900 mb-4">리포트 다운로드</h3>
        ...
        <div className="bg-gray-50 border border-gray-200 p-4 mb-6">
          <div className="text-sm text-gray-700 space-y-1">
            <p>• 탄소배출 73% 감소 실측 데이터</p>
            <p>• 재생에너지 전환 케이스 스터디</p>
            <p>• 2025년 임팩트 성과 분석</p>
            <p>• 24페이지 PDF (3.2MB)</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full py-3 bg-gray-900 text-white hover:bg-gray-800 transition-colors"
          >
            리포트 받기
          </button>
        </form>
