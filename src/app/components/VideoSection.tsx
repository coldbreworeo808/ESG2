    ...
    <section id="video" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative aspect-video bg-gray-200 border-2 border-gray-300 flex items-center justify-center group cursor-pointer hover:border-gray-900 transition-colors">
            {/* Thumbnail Placeholder */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-gray-400 text-center">
                <div className="text-sm mb-2">[ 영상 썸네일 ]</div>
                <div className="text-xs">16:9 비율</div>
              </div>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            <p>NEXWAVE Energy Impact Report 2025</p>
